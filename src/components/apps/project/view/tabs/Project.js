    ...
    return (
        <Row gutter={12}>
            <Col span={7}>
                <Row
                    className={
                        "rounded-[8px] border-solid border-[1px] border-[#ccc] w-full h-fit"
                    }
                >
                ...
                >
                    ...
                    <Row className={"h-[400px] overflow-x-hidden"}>
                        <CommentList
                            classPkId={data.id}
                            classPkName={CLASS_PK_NAME.PROJECT}
                        />
                    </Row>
                </Row>
            </Col>
            <Col span={17}>
                ...
                <Row className={"mt-1.5 h-fit"}>
                    <Col
                        className={
                            "rounded-[8px] border-solid border-[1px] border-[#ccc] p-6 w-full"
                        }
                    >
                        <div>
                            <span>
                            ...
                            <Link
                                to={`/project/view/${data.id}?tab=phase`}
                ...
                <Row className={"mt-1.5"}>
                    ...
                    >
                        <div>
                            ...
                            <Link
                                to={`/project/view/${data.id}?tab=work`}
                                style={{ fontSize: 12, paddingLeft: 7 }}
                            >
                                <i>Chi tiết</i>
                            </Link>
